 ...
 * @author Fernando
 */
public class CatalogLong {
    public int Amount;
    
    private int currentIndex;
    private ArrayList<ItemLong> arrayBase;
    private int countItems;

    private class ItemLong {
    ...
    public CatalogLong() {
        currentIndex = -1;
        countItems = 0;
        arrayBase = new ArrayList<ItemLong>();
    }

    private void Sort(ItemLong item) {
